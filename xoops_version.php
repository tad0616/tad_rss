...
//---模組狀態資訊---//
$modversion['release_date'] = '2014/01/13';
...
$i=1;
$modversion['templates'][$i]['file'] = 'tad_rss_index_tpl.html';
$modversion['templates'][$i]['description'] = 'tad_rss_index_tpl.html';
...
$modversion['blocks'][1]['template'] = "tad_rss_show.html";
